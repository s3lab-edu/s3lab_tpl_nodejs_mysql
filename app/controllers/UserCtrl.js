...
module.exports = {
    ...
    getOne: function (req, res) {
        ...
        if(id === 'statistic'){
            ...
            UserManager.getOne(accessUserId, id, function (errorCode, errorMessage, httpCode, errorDescription, result) { //, accessUserType
                if (errorCode) {
                    return Rest.sendError(res, errorCode, errorMessage, httpCode, errorDescription);
                }
                return Rest.sendSuccessOne(res, result, httpCode);
    ...
    update: function (req, res) {
        ...
        if( id === 'deletes' ){
            ...
            let accessLoginName = req.body.accessLoginName || '';
            let data = req.body || '';
            UserManager.update( accessUserId, accessLoginName, id, data, function (errorCode, errorMessage, httpCode, errorDescription, result) { // , accessUserType
                if (errorCode) {
                    return Rest.sendError(res, errorCode, errorMessage, httpCode, errorDescription);
                }
                let resData = {};
