...
module.exports = {
    ...
    notifyUpgrade:function (req, res) {
        ...
        console.log('hello day la id o devicectrl: ' ,id);
    ...
    getOne: function (req, res) {
        ...
        if(id === 'statistic'){
            ...
            DeviceManager.getOne(accessUserId, id, function (errorCode, errorMessage, httpCode, errorDescription, device) { //, accessUserType
                if (errorCode) {
                    return Rest.sendError(res, errorCode, errorMessage, httpCode, errorDescription);
                } else {
