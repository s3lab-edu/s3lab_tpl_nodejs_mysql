...
module.exports = {
    ...
    getOne: function(accessUserId, id, callback) { // , accessUserType
        try {
    ...
    update: function (accessUserId, accessLoginName, userId, updateData, callback) { // , accessUserType
        try {
            let queryObj = {};
            let where = {};
            ...
            //console.log(error); không phai loi o day
    ...
    verifyUser: function (accessUserId,accessUserType, accessLoginName, callback) {
        try {
            ...
            let where = {id: accessUserId, loginName:accessLoginName, activated:Constant.ACTIVATED.YES}; // , type:accessUserType
            let attributes = ['id', 'loginName','email','type', 'displayName', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy'];
